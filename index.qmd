...
result1 %>% 
  ...
  set_header_labels(
    ...
    add_header_row( values = c("","Years Living With Disease","Years of Life Lost to Premature Mortality","Disability-Adjusted Life Years"),colwidths = c(1,2,2,2)) %>% 
...
cea %>% 
  ...
  set_header_labels(
    ...
    add_footer_lines("MT: Markov Trace [Approach 1]; MCwR = Markov Chain with Rewards [Approach 3]; AccDeath = Accumulate time in absorbing death state; QALY-DALY = QALY-like DALY; D = dominated strategy") %>% 
