...
result1 %>% 
  ...
  kable(col.names = c("",rep(c("Markov Trace (1&2)","Markov Chain With Rewards (3)"),3)), digits = 3) %>% 
  kable_styling() %>% 
...
@tbl-cea reports cost, effect and incremental cost-effectiveness ratio (ICER) results for our three strategies. The table also includes results under two "shortcut" DALY strategies. As above, there is a roughly 3% difference in outcome estimates, including ICERs, across our three approaches. 
...
cea %>% 
  ...
  kable(col.names = c("","Markov Trace (1&2)","Markov Chain With Rewards (3)", "Markov Trace (1&2)","Markov Chain With Rewards (3)","Death State Occupancy","QALY-like DALY",
                     "Markov Trace (1&2)","Markov Chain With Rewards (3)", "Death State Occupancy","QALY-like DALY")) %>% 
  kable_styling() %>% 
