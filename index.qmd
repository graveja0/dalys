...
Next, the approach labeled **QALY-like DALY** defines the cycle occupancy payoff for the sick and sicker states as one minus the disability weight; as in many QALY applications, the healthy state receives a payoff value of 1.0. 
...
Finally, it is important to note that the methods outlined here are not purely restricted to DALY outcomes. Indeed, each approache facilitates the estimation of other common outcomes such as QALYs, life-years, etc.
