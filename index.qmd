...
YLLs are determined by a loss function, which is typically defined as the number of years lost to premature mortality at age $a$. This value is often taken directly from a life table that provides information on remaining life expectancy at age $a$,
...
(e.g., DALYs for healthy 55 year-olds). We obtain these expected outcomes by,
...
result1 %>% 
  ...
  kable(col.names = c("",rep(c("Markov Trace (1&2)","Markov Chain (3)"),3)), digits = 3) %>% 
  kable_styling() %>% 
  add_header_above(c("", "YLD" = 2, "YLL"=2, "DALY"=2)) 
```
...
cea %>% 
  ...
  kable(col.names = c("","Markov Trace (1&2)","Markov Chain (3)", "Markov Trace (1&2)","Markov Chain (3)","Death State Occupancy","QALY-like DALY",
                     "Markov Trace (1&2)","Markov Chain (3)", "Death State Occupancy","QALY-like DALY")) %>% 
  kable_styling() %>% 
  add_header_above(c("", "Cost Estimate" = 2, "DALY Estimate"=4, "ICER"=4)) 
